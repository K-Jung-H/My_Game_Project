...
public:
    ...
    D3D12_GPU_VIRTUAL_ADDRESS GetSkinnedOutputGPUVA() const { return mSkinnedHotVB ? mSkinnedHotVB->GetGPUVirtualAddress() : 0; }
    ...
    UINT SkinnedUAV = UINT_MAX;
    UINT SkinnedVBVSRV = UINT_MAX;
...
protected:
    ...
    ComPtr<ID3D12Resource> mSkinnedHotVB;
